...
export default function Subleq()
{
    return (
        <div className="h-full w-full flex flex-col items-center justify-center">
            <div>
                SUBLEQ (Subtract and Branch if Less Than or Equal to Zero) is a type of One Instruction Set Computer (OISC), meaning it uses only one instruction to perform all operations. The SUBLEQ instruction subtracts the contents of one memory location from another and branches to a specified address if the result is negative. 
            </div>
            <div>
