  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <div className="sm:hidden absolute z-10 self-center w-1/2 h-6 bg-black rounded-b-full top-0"/>
      </div>
      
      {/* Terminal content */}
      <div className="overflow-auto z-0 p-2 mt-5 sm:mt-8 text-slate-400">
        {children}
      </div>
    </ScrollArea>
  );
